...
*/
public class V1639254964040__CreateTableUser extends BaseJavaMigration {
        ...
        create.transaction(configuration -> {
            using(configuration)
                .createTableIfNotExists("user")
                    ...
                    .column("document", VARCHAR(100).nullable(true))
                    .column("drivers_license", VARCHAR(100).nullable(true))
